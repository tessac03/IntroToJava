...
public class RandomWalker {
    public static void main(String[] args){
        //Create variable n from the command line argument input to be used as the
        //number of steps to take, and variables x,y to chart the random walk
        int n = Integer.parseInt(args[0]);
        int x=0, y=0;
        
        //while loop to generate n many random steps and print out each point
        while(n>0){
        ...
        //print the final point in the random walk and compute and print out 
